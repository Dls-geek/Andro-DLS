...
def get_screenshot(config: AppConfig) -> None:
    ...
    out_dir = ensure_config_dir(config, "screenshot_location", "Screenshots")
...
def screenrecord(config: AppConfig) -> None:
    ...
    if duration_sec is None:
        return
    out_dir = ensure_config_dir(config, "screenrecord_location", "Screen-Records")
...
def record_audio(config: AppConfig, mode: str) -> None:
    ...
    save_dir = ensure_config_dir(config, "pull_location", "Audio")
